package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class FieldDescriptor$TYPE_MESSAGE extends FieldDescriptor
   {
      ...
      public function FieldDescriptor$TYPE_MESSAGE(fullName:String, name:String, tag:uint, messageUnion:Object)
      {
         super();
      ...
      {
         return ReadUtils.read$TYPE_MESSAGE(input,new this.type());
      }
