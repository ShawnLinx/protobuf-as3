package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptor$TYPE_MESSAGE extends RepeatedFieldDescriptor
   {
      ...
      public function RepeatedFieldDescriptor$TYPE_MESSAGE(fullName:String, name:String, tag:uint, messageUnion:Object)
      {
         super();
      ...
      {
         return ReadUtils.read$TYPE_MESSAGE(input,new this.elementType());
      }
